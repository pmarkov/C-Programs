...
int main()
{
	...
	{
		flag = 0;
		printf("Въведете името на програмата, която искате да прочетете: ");
		...
		for (int i = 0; i < strlen(sourceFileName); i++)
		{
			if (sourceFileName[i] == '.')
				...
				{
					printf("Файлът не е в .с формат!");
					flag = 1;
				}
		}
	}
	printf("\nВъведете името на файла, където искате да запишете програмата: ");
